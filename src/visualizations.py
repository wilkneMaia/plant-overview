...
def display_home_page(df):
    ...
    with col1:
        st.markdown(plant_overview_card, unsafe_allow_html=True)
    with col2:
        st.markdown(plant_revenue_card, unsafe_allow_html=True)
    with col3:
        st.markdown(environmental_benefits_card, unsafe_allow_html=True)
